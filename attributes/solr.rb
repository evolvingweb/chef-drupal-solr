...
default['deploy-drupal']['solr']['php_client_url'] =
...
default['deploy-drupal']['solr']['apachesolr_conf_dir'] =
  node['deploy-drupal']['solr']['apachesolr_install_dir'] +
  "/apachesolr/solr-conf/solr-" +
  node['deploy-drupal']['solr']['version'].split(".")[0]+".x"

if node['deploy-drupal']['solr']['version'].split(".")[0] == "1" then
  default['deploy-drupal']['solr']['apachesolr_conf_dir'] =
    node['deploy-drupal']['solr']['apachesolr_install_dir'] + "/apachesolr/solr-conf/solr-1.4"
end
